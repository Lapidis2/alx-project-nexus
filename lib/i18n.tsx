  ...
  resources: {
    ...
    FR: {
      translation: {
       ...
       "Enter your credentials": "Entrez vos identifiants",
        ...
        AboutUs:
          "Jean Essentials est une équipe de développeurs passionnés par la création d'expériences de shopping en ligne. Notre objectif est de rendre le shopping facile et agréable pour tout le monde. Nous nous concentrons sur la conception de sites Web faciles à utiliser et attrayants. Que vous achetiez des vêtements, des appareils électroniques ou tout autre produit, nous voulons que vous ayez une expérience fluide et agréable. Les vendeurs peuvent également créer des comptes sur notre plateforme pour vendre leurs produits à un large public. Nous sommes là pour aider les acheteurs et les vendeurs à se connecter dans un environnement convivial et fiable. Rejoignez-nous et explorez un monde de shopping en ligne sans couture!",
        ...
        abouts:
          "Jean Essentials s'engage à fournir des produits de qualité et un excellent service à nos clients. Nous nous efforçons d'apporter des articles uniques et innovants qui améliorent votre style de vie..",
        Links: "Liens",
        Home: "Accueil",
        Products: "Produits",
        ...
        Tel: "Tel",
        Email: "Email",
        "© 2024 Upscale Jean Essentials, all rights reserved":
          "© 2024 Upscale Jean Essentials, tous droits réservés",
    ...
    KINY: {
      translation: {
        ...
        abouts:
          "Jean Essentials yiyemeje gutanga ibicuruzwa byiza na serivisi nziza kubakiriya bacu. Twiyemeje kuzana ibicuruzwa byihariye kandi bishya bigira uruhare mw'iterambere ry'imibereho yawe..",
        Links: "Amakuru",
        Home: "Ahabanza",
        Products: "Ibicuruzwa",
        "About Us": "Ibyacu",
        ...
        Email: "Imeyili",
        "© 2024 Upscale Jean Essentials, all rights reserved":
          "© 2024 Upscale Jean Essentials, uburenganzira bwose burabitswe",
