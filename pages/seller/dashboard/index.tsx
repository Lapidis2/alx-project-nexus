...
const SellerDashboard: React.FC = () => {
  ...
  return (
	<div className="flex flex-col w-full min-h-screen space-y-6 px-4 lg:px-6 xl:px-8 py-6 pt-20 ">
	  ...
	  <div className="w-full lg:max-w-[calc(100%-16rem)] mx-auto space-y-6">
		...
		<div className="flex flex-col lg:flex-row w-full gap-5">
		  ...
		  <div className="w-full lg:w-1/2 bg-white p-4 rounded-lg shadow-sm overflow-auto">
		  ...
		  <div className="w-full lg:w-1/2 bg-white p-4 rounded-lg shadow-sm overflow-auto">
			...
			<ul>
			  {products.map((p) => (
				...
				>
				  <div className="flex items-center gap-2 relative w-40 md:w-48 lg:w-auto">
