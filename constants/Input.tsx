...
const Input: React.FC<InputProps> = ({ label, type, value, placeholder, onChange, error }) => {
  ...
  return (
    <div className="flex flex-col gap-1 w-full">
      <label className="text-[16px] font-[400] text-[#666666] font-outfit">{label}</label>
      <div className="relative w-full flex items-center">
        <input
          ...
          className={`p-3 border rounded-[12px] font-outfit outline-none placeholder:font-[400] w-full ${
