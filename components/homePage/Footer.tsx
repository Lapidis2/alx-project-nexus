      ...
      <section className="container mx-auto px-4 md:px-8 border-b border-border pb-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <nav className="footer-links max-w-full md:max-w-md" aria-label="Footer Navigation">
          ...
          <ul className="grid grid-cols-2 gap-2">
            <li>
              <Link href="/" title="Home" className="text-white hover:underline">
                {t("Home")}
              </Link>
            </li>
            <li>
              <Link href="/products" title="Products" className="text-white hover:underline">
                {t("Products")}
              </Link>
            </li>
            <li>
              <Link href="#AboutJEAN" title="About Us" className="text-white hover:underline">
                {t("About Us")}
              </Link>
            </li>
            <li>
              <Link href="#ContactSection" title="Contact Us" className="text-white hover:underline">
                {t("Contact Us")}
              </Link>
            </li>
          </ul>
