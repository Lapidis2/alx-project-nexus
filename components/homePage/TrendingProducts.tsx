  ...
  return (
    <section className="py-16 px-6 sm:px-12 md:px-24 font-outfit bg-white min-h-screen">
      <div className="mb-8 flex items-center">
        ...
        <h2 className="text-xl sm:text-2xl font-bold text-black">TRENDING PRODUCTS</h2>
      </div>
        ...
        {currentProducts.map((product) => {
          ...
          return (
            <div
              ...
              className="rounded-lg shadow-md p-4 transform transition-all duration-300 hover:scale-105 hover:shadow-xl bg-white relative"
            >
              {loading ? (
