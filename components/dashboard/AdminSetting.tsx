...
interface AdminSettingsProps {
  user: User;
  updatePassword: (id: string, passwords: Passwords) => Promise<void>;
}

const AdminSettings: React.FC<AdminSettingsProps> = ({ user, updatePassword }) => {
  ...
  return (
    <section className="h-[90%] w-full mt-2 md:mt-4 lg:mt-6 bg-white rounded-lg shadow-md p-6 lg:ml-5 xl:ml-8 2xl:ml-10 3xl:ml-12">
      <ToastContainer />
      {!isChangingPassword ? (
        <div>
          <h2 className="text-xl text-center font-bold mb-4">Profile Information</h2>
          <div className="mb-4">
        ...
        <form onSubmit={handleSubmit}>
          <h2 className="text-xl text-center text-primary font-bold mb-4">Change Password</h2>
          <div className="mb-4">
