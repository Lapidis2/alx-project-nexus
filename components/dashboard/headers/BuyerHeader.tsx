  ...
  return (
    <header className="fixed top-0 left-0 lg:left-80 w-full lg:w-[calc(100%-20rem)] bg-white shadow-md px-4 py-2 flex items-center justify-between z-50 transition-all">
      ...
      <div className="flex items-center space-x-2 lg:hidden">
        <Link href="/buyer">
          <span className="text-xl font-bold text-gray-800">BuyerPanel</span>
        </Link>
      </div>
      ...
      {isMenuOpen && (
        <div className="absolute top-16 right-4 bg-white shadow-md rounded-md p-2 flex flex-col space-y-2 lg:hidden">
          <Link href="/buyer" onClick={() => handleNavigation("/buyer")}>Dashboard</Link>
          <Link href="/buyer/analytics" onClick={() => handleNavigation("/buyer/analytics")}>Analytics</Link>
          <Link href="/buyer/settings" onClick={() => handleNavigation("/buyer/settings")}>Settings</Link>
        </div>
      )}
